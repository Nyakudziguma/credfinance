    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('general_user', 'general_user'), ('administrator', 'administrator'), ('finance_manager', 'finance_manager')], default='general_user', max_length=255)),
